...
fn export_bindings() {
    ...
    export!(
        ...
        GitHubRepo, PtySpec, PtyEvent, WslState, WslStatus, ProvisionEvent, McpTransport, EnvVar, McpServerConfig, QuestionOption, AgentQuestion, QuestionAnswer, CheckpointRecord, FsEntry, FsFile, StackRecommendRequest, StackRecommendation, SshKeyInfo, PreviewEvent, PreviewStatus,
    );
}
